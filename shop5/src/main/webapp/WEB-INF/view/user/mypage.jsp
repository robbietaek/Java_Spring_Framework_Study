...
<c:forEach items = "${salelist}" var = "sale" varStatus = "stat">
	...
	${sale.user.username}(${sale.user.userid})</c:if></td>
	<td align = "center"><fmt:formatDate value="${sale.updatetime }" pattern = "yyyy-MM-dd HH:mm:ss"/>
