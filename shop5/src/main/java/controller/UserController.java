...
public class UserController {
	...
	@PostMapping(value = "password", produces="text/html;charset=UTF-8")		//한글이 넘어가려면 produces를 써줘야한다. "text/plain;charset=UTF-8" 이렇게 쓰면 순수 문자를 보낸다.
	@ResponseBody		//이걸 써줬기 때문에 script로 바로 보내줄 수 있는 것이다. return 자체를 view의 내용으로 전달한다.
