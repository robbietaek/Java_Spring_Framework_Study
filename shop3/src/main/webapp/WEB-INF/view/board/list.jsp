	...
	<table>
		...
		<c:if test="${listcount>0}">
			...
			<c:forEach var="board" items="${boardlist}">
				<tr>
					<td>${boardno}</td>
					<c:set var="boardno" value="${boardno-1 }" /> <%--하나씩 줄여주기 위해 --%>
					...
					<c:forEach begin="1" end="${board.grplevel}">&nbsp;&nbsp;</c:forEach> <%--답변글인경우 들여쓰기 --%>
		...
		<tr>
			<td colspan="5" align="right"><a href="write.shop">[글쓰기]</a></td>
		</tr>
